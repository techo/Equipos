...
export default function CardInfoEquipo({ equipo, cantMiembros, setCantMiembros }) {
  ...
  useEffect(() => {
    const promesas = [
      ...
      axios.get("http://159.223.219.133:3001/api/sedes"),
      axios.get(`http://159.223.219.133:3001/api/equipos/cantMiembros/${equipo.id}`),
      axios.get("http://159.223.219.133:3001/api/comunidades", {
