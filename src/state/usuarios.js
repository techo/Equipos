...
export const toggleAdmin = createAsyncThunk("TOGGLE_ADMIN", ({ idPersona, errorAlert }) => {
  return axios
    .post(`http://159.223.219.133:3001/api/usuarios/${idPersona}/toogleAdmin`, {
...
export const getByMail = createAsyncThunk(
  ...
  ({ mail, errorAlert }) => {
    return axios
      .get(`http://159.223.219.133:3001/api/usuarios/filtrar/mail/${mail}`, {
...
export const getById = createAsyncThunk(
  ...
  ({ id, errorAlert }) => {    
    return axios
      .get(`http://159.223.219.133:3001/api/usuarios/filtrar/id/${id}`, {
        headers: { Authorization: getToken() },
      })
      .then((res) => res.data)
      .catch(() =>
